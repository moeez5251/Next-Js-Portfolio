...
const techStack: TechItem[][] = [
  ...
  // Row 3 - 7 items
  [
    { name: "Railway", icon: "https://logo.svgcdn.com/devicon/railway-original.svg", url: "https://railway.app" },
    { name: "Digital Ocean", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/digitalocean/digitalocean-original.svg", url: "https://digitalocean.com" },
  ...
  // Row 4 - 5 items
  [
    { name: "Appwrite", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/appwrite/appwrite-original.svg", url: "https://appwrite.io" },
    { name: "Aurdino", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/arduino/arduino-original.svg", url: "https://developer.mozilla.org/en-US/docs/Web/JavaScript" },
    { name: "Canva", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/canva/canva-original.svg", url: "https://typescriptlang.org" },
    { name: "Cloudflare", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/cloudflare/cloudflare-original.svg", url: "https://en.cppreference.com/w/c" },
    { name: "npm", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/npm/npm-original.svg", url: "https://isocpp.org" },
  ],
  // Row 5 - 3 items
  [
    ...
    { name: "Vite", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/vite/vite-original.svg", url: "https://vitejs.dev" },
    { name: "Windows", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/windows11/windows11-original.svg", url: "https://react.dev" },
  ],
  // Row 6 - 2 items
  [
    { name: "Next.js", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/nextjs/nextjs-original.svg", url: "https://nextjs.org" },
